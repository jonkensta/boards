...
C1 = b.footprint('C1', 40.5, 5.6, 0, ref_fab=True)            # 10u LDO in: 1 5V (39.725) 2 GND (41.275)
...
C7 = b.footprint('C7', 42.8, 15.375, 0, ref_fab=True)         # 2.2u LDOO: 1 (42.025) 2 GND (43.575)
...
C11 = b.footprint('C11', 42.4, 12.4, 270, ref_fab=True)       # 100n DVDD: 1 top (42.4,11.625) rail, 2 bottom GND (13.175)
...
b.seg('+5V', SIG, C1['1'], (39.725, 4.0))
b.seg('GND', SIG, C1['2'], (42.0, 5.6)); b.via('GND', 42.0, 5.6)
...
b.seg('+3V3', PWR, (22.175, RAIL), (42.4, RAIL))
...
b.seg('+3V3', S2, U1['20'], (41.3, 14.075), (41.5, 13.875), (41.5, RAIL))               # DVDD
b.seg('+3V3', SIG, C11['1'], (42.4, RAIL)); b.seg('GND', SIG, C11['2'], (42.4, 14.0)); b.via('GND', 42.4, 14.0)
b.seg('GND', S2, U1['19'], (41.1, 14.725)); b.via('GND', 41.1, 14.725)                   # DGND
b.seg(N('U1', '18'), S2, U1['18'], C7['1']); b.seg('GND', SIG, C7['2'], (44.1, 15.0)); b.via('GND', 44.1, 15.0)   # LDOO
XS = N('U1', '17')
...
b.seg(XS, S2, (40.9, 16.025), (40.9, 25.0), (50.0, 25.0), J1['6'], layer='B.Cu')
...
b.seg('GND', S2, U1['12'], (40.9, 19.275), (40.9, 20.6), (40.1, 21.2)); b.via('GND', 40.1, 21.2)  # SCK
...
b.seg(OR_, SIG, (32.85, 17.975), (34.5, 19.625), (34.5, 22.4), (20.9, 22.4), layer='B.Cu'); b.via(OR_, 20.9, 22.4); b.seg(OR_, SIG, (20.9, 22.4), R5['1'])
