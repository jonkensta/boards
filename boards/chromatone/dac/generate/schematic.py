...
for pin, upin, ref, tp in (('3', '15', 'R1', ('TP1', 'LRCK', TPT)), ('4', '14', 'R2', None), ('5', '13', 'R3', ('TP2', 'BCK', TPB))):
    ...
    r = s.place('Device', 'R', ref, rx, y, rot=90, value='33', footprint=R_FP, prop_pos={'Reference': (-3.0, -2.3), 'Value': (3.0, -2.3)} if pin != '4' else {'Reference': (-3.0, 2.3), 'Value': (3.0, 2.3)})
...
R6 = s.place('Device', 'R', 'R6', g(76), g(101), value='10k', footprint=R_FP, prop_pos={'Reference': (1.5, -1.27), 'Value': (1.5, 1.27)})
...
C5 = s.place('Device', 'C', 'C5', g(116), g(91), value='2.2u', footprint=C_FP, description='2.2 uF X5R 10 V flying cap', prop_pos={'Reference': (1.5, -1.27), 'Value': (1.5, 1.27)})
s.wire(U1['2'], C5['1']); s.wire(U1['4'], C5['2'])
C6 = s.place('Device', 'C', 'C6', g(120), g(103), value='2.2u', footprint=C_FP, description='2.2 uF X5R 10 V (VNEG)', prop_pos={'Reference': (1.5, -1.27), 'Value': (1.5, 1.27)})
s.wire(U1['5'], (g(120), g(100)), C6['1']); s.wire(C6['2'], (g(120), g(108))); s.power('GND', g(120), g(108))
C7 = s.place('Device', 'C', 'C7', g(124), g(101), value='2.2u', footprint=C_FP, description='2.2 uF X5R 10 V (LDOO 1.8 V)', prop_pos={'Reference': (1.5, -1.27), 'Value': (1.5, 1.27)})
...
R4 = s.place('Device', 'R', 'R4', g(116), g(82), rot=90, value='470', footprint=R_FP, prop_pos={'Reference': (-3.0, -2.3), 'Value': (3.0, -2.3)})
R5 = s.place('Device', 'R', 'R5', g(120), g(84), rot=90, value='470', footprint=R_FP, prop_pos={'Reference': (-3.0, 2.3), 'Value': (3.0, 2.3)})
s.wire(U1['6'], R4['1']); s.wire(U1['7'], R5['1'])
C8 = s.place('Device', 'C', 'C8', g(127), g(79), rot=180, value='2.2n', footprint=C_FP, description='2.2 nF C0G 50 V', prop_pos={'Reference': (1.5, -1.27), 'Value': (1.5, 1.27)})
C9 = s.place('Device', 'C', 'C9', g(131), g(87), value='2.2n', footprint=C_FP, description='2.2 nF C0G 50 V', prop_pos={'Reference': (1.5, -1.27), 'Value': (1.5, 1.27)})
...
# ---- decoupling cluster + LED + flags ---------------------------------------------
def cap(ref, x, val, desc, rail_top, rail_bot, vcc):
    c = s.place('Device', 'C', ref, x, g(58), value=val, footprint=C_FP, description=desc, prop_pos={'Reference': (1.5, -1.27), 'Value': (1.5, 1.27)})
    s.wire(c['1'], (x, rail_top)); s.wire(c['2'], (x, rail_bot)); s.power(vcc, x, rail_top); s.power('GND', x, rail_bot)
top, bot = g(53), g(63)
cap('C1', g(86), '10u', '10 uF X5R 10 V (LDO in)', top, bot, '+5V')
for i, (ref, val, desc) in enumerate([('C2', '10u', '10 uF X5R 10 V (LDO out)'), ('C3', '10u', '10 uF X5R 10 V (AVDD)'), ('C4', '10u', '10 uF X5R 10 V (CPVDD)'),
...
x = g(134)
R7 = s.place('Device', 'R', 'R7', x, g(56), value='1k', footprint=R_FP, prop_pos={'Reference': (1.5, -1.27), 'Value': (1.5, 1.27)})
D1 = s.place('Device', 'LED', 'D1', x, g(64), rot=90, value='GREEN', footprint=LED_FP, prop_pos={'Reference': (1.5, -1.27), 'Value': (1.5, 1.27)})
