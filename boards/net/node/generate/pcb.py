...
the edge), RP2040 top-left with its flash below, LEDs right of centre, pogo pads bottom-left,
ToF sensor and header bottom-right, LDO and piezo top-right, M2 holes in the corners. See README.md (PCB section) for the plan.
...
C3 = b.footprint('C3', 33.0, 17.5, 0, ref_fab=True)               # plane cap in BZ1's old spot: 1 3V3 (32.225,17.5) 2 GND (33.775,17.5)
...
J6Y = 40.3                                                       # pogo block moved 2.3 mm south to make room for J4
J6 = b.footprint('J6', 12.5, J6Y, 90, ref_pos=(0, -7.0))          # boards:PogoPads (no paste): even row y 37.775: 2 SWDIO 8.69, 4 SWCLK 11.23, 6 RUN 13.77, 8 BOOT 16.31; odd row y 42.825: 1 DM, 3 DP, 5 GND, 7 +5V
...
D1 = b.footprint('D1', 34.7, 22.0, 0, ref_fab=True)               # 1N4148W: 1 K LED_VDD (33.05,22) 2 A +5V (36.35,22)
# LDO top-right; C8/C5 are plane caps, now under R17/R18 in BZ1's old spot
...
C8 = b.footprint('C8', 31.0, 12.5, 0, ref_fab=True)               # 100n: 1 3V3 (30.225,12.5) 2 GND (31.775,12.5)
C5 = b.footprint('C5', 31.0, 14.3, 0, ref_fab=True)               # 100n, shares C8's vias
# piezo element in the NE corner between the LDO row and J2; GPIO12/13 (pins 15/16) arrive on rows y 5.4 / 6.2
BZ1 = b.footprint('BZ1', 41.8, 13.4, 0, ref_fab=True)             # pads 1 (37.45,13.4) left, 2 (46.15,13.4) right
R18 = b.footprint('R18', 31.3, 6.7, 0, ref_fab=True)              # BUZZ_B: 1 (30.475,6.7) 2 (32.125,6.7)
R17 = b.footprint('R17', 31.3, 8.3, 0, ref_fab=True)              # BUZZ_A: 1 (30.475,8.3) 2 (32.125,8.3)
# links: 100 R series near the connector, 4k7 pull-up beside it (R_0603 pads at +-0.825, C_0603 at +-0.775)
R7 = b.footprint('R7', 24.0, 12.6, 90, ref_fab=True)              # N: 2 J1 (24,11.775) top, 1 LINK_N (24,13.425); below the SDA/SCL rows
R8 = b.footprint('R8', 22.5, 12.6, 270, ref_fab=True)             # N pull-up: 1 3V3 (22.5,11.775) 2 LINK_N (22.5,13.425)
R9 = b.footprint('R9', 35.5, 24.0, 0, ref_fab=True)               # E: 1 LINK_E (34.675,24) 2 J2 (36.325,24)
R10 = b.footprint('R10', 35.5, 25.6, 180, ref_fab=True)           # E pull-up: 2 LINK_E (34.675,25.6) 1 3V3 (36.325,25.6)
...
T(BB, (16.2, 9.125), (16.2, 8.9), (19.7, 5.4), (29.8, 5.4), (30.475, 6.075), R18['1'])   # rows y 5.4 / 6.2 clear J1's pins; right pin (15) bends first
T(BA, (16.6, 9.125), (16.6, 9.1), (19.5, 6.2), (28.6, 6.2), (29.4, 7.0), (29.4, 7.6), (30.1, 8.3), R17['1'])
T(N('R18', '2'), R18['2'], (32.725, 7.3), (45.5, 7.3), (46.15, 7.95), BZ1['2'])                  # over the top of BZ1, below the H2 keepout
T(N('R17', '2'), R17['2'], (33.0, 8.3), (37.45, 12.75), BZ1['1'])
...
# ---- west B.Cu lanes: SENS_AIN 5.2, SWDIO 5.7, SWCLK 6.3, RUN 6.8 (west of J4's pins); vias sit inside the pogo pads
...
T(SS, (16.31, 33.0), J6['8'])                                                          # -> J6.8 BOOT
...
T(J6DM, (11.7, 22.225), (11.7, 22.55), (11.15, 23.1), (10.9, 23.5), (10.9, 25.0), (9.9, 26.0), (9.9, 39.8), (9.2, 40.5), (8.69, 41.0), J6['1'])   # between J4's pins and R13/R14
T(J6DP, (11.7, 25.625), (11.7, 26.0), (10.5, 27.2), (10.5, 33.0), (12.1, 34.6), (12.1, 40.4), (11.4, 41.1), (11.23, 41.3), J6['3'])
...
pad_via(V3, *C3['1'], C3['1'][0], 18.4); pad_via(G, *C3['2'], C3['2'][0], 18.4)                 # C3 plane cap
...
T(INT, (38.4, 31.9), (38.4, 32.725)); T(INT, (43.27, 33.5), (43.27, 37.2), J5['3'], layer=B)   # SW1.2 (THT, copper even when DNP) -> J5.3
T(N('SW1', '2'), (43.27, 33.5), (43.27, 32.0), (39.0, 32.0), (38.4, 32.6))
...
V(N('R7', '2'), 24.0, 11.6); T(N('R7', '2'), J1['2'], (24.0, 11.6), layer=B)                  # J1.2 on B.Cu under SDA/SCL, via touching R7.2
V(V3, 22.5, 11.6)                                                                              # R8.1 (via touching the pad: SDA is right above)
# LINK_E: B.Cu north on x 22.2, east on y 15.4, south on x 34.675 to the via between R9.1 and R10.2
T(LE, (XK[1], 20.1), (XK[1], 15.4), (34.675, 15.4), (34.675, 24.8), layer=B); V(LE, 34.675, 24.8)
T(LE, R9['1'], R10['2']); T(N('R9', '2'), R9['2'], J2['2']); pad_via(V3, *R10['1'], 36.325, 26.5)
...
T(LVDD, D2['4'], (27.75, 23.085), (27.75, 21.2), (31.0, 21.2), (31.6, 21.8), (31.6, 22.825)); T(LVDD, (31.0, 21.2), (32.3, 21.2), D1['1'])
...
pad_via(V5, *D1['2'], 37.2, 22.0, w=P); T(V5, (37.2, 22.0), (37.2, 25.8), (37.9, 26.5), J2['1'], w=P, layer=B)   # D1.2 -> J2.1 on B.Cu under the R9 -> J2.2 run
...
T(V3, C8['1'], C5['1']); T(G, C8['2'], C5['2']); V(V3, 30.225, 13.4); V(G, 31.775, 13.4)          # C8/C5 plane caps share a via per net
...
pad_via(G, 34.875, 33.8, 35.6, 33.8); pad_via(G, 34.875, 35.4, 35.6, 35.4)
...
b.zone('GND', 'GND-B', 0, 0, W, H, layer='B.Cu', thermal_gap=0.3, thermal_bridge=0.4)   # narrower reliefs (from the vertical-connector layout, where J4.3 sat between the ring and a lane)
b.outline_rect()
b.write(PCB)
print('wrote', PCB)
